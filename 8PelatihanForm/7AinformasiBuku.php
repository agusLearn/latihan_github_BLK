...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			<h1 class="display-4">Informasi Pembelian Buku</h1>

			<p class="lead">Jumlah Buku yang dibeli : 
				<b> <?= $_POST["buku"];  ?> </b>
			</p>
			<p class="lead">Jumlah Harga Per-Buku 	:  
				<b> <?= $_POST["harga"];  ?>
			</p>
			<hr class="my-4">
			...
			if ($buku > 20) {
				$jumlahHarga = "Biaya Pembelian dengan Harga Diskon(%5)  = Rp.<b>$hargaPemebelian</b>";
			}
			else{
				$jumlahHarga = "Total Harga Buku  = Rp.<b>$totalHarga</b>";
			}
			?>
			<p>Total Harga Pembelian Buku : <?= $totalHarga; ?></p>
			<p><?= $jumlahHarga; ?></p>
		</div>
	</div>
